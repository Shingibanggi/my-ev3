all: ev3dev.a test1.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o test1 test1.o h_crane.o -lev3dev
...
test1.o: test1.cpp
		arm-linux-gnueabi-g++-4.7 -c test1.cpp -o test1.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
